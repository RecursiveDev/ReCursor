...
class _$AppNotificationImpl implements _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, sessionId: $sessionId, type: $type, title: $title, body: $body, priority: $priority, data: $data, timestamp: $timestamp, isRead: $isRead)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, sessionId, type, title, body,
      priority, const DeepCollectionEquality().hash(_data), timestamp, isRead);
